...
def process_config():
        ...
        data_arg.add_argument('--use_paragraph', type=str2bool, default=False, help="whether to use tokenizer after paragraph")  #
        ...
        net_arg.add_argument('--target_model', type=str, default="ilcr_sc", 
        ...
        specific_arg.add_argument('--look_forward_ratio', type=float, default=0.15)  # used in stack_tt

        specific_arg.add_argument('--output_attentions', type=str2bool, default=True)  # used in huggingface
        specific_arg.add_argument('--topk_fwr', type=int, default=1)  # used in cent_attn
        specific_arg.add_argument('--threshold_sim', type=float, default=0.955)  # used in cent_attn
